  ...
  pages: [
    ...
    },
    {
      ...
      versions: [
        ...
        { id: 'draft7', date: '', note: '案7: draft6 複製。新卒と未経験を 1 ページにする決定(2026-09-07)を受け、採用案内を「新卒・未経験採用(ENTRY LEVEL → /graduate-pre)/ 中途採用」の 2 行に' },
      ],
    },
    {
      id: 'career',
    ...
    },
    {
      ...
      versions: [
        ...
        { id: 'draft2', date: '', note: '案2: 文書型(career/draft2 と同じ CSS)。仕事内容は文章、募集職種は募集要項の最初の行に、ステップ 4 つは番号付き 2 列、キャリア 5 つは 2 列、締めは一文 + 紺ボタン。タイトル帯を「新卒・未経験採用 / New Graduate / Entry Level」に(新卒と未経験を 1 ページにする決定)' },
      ],
    },
  ],
};
